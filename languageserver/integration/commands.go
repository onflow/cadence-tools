...
// clientProvider abstracts client resolution so tests can stub it and
// production can use *ConfigManager.
type clientProvider interface {
    ResolveClientForPath(string) (flowClient, error)
    DefaultClient() flowClient
    ReloadAll() error
}
